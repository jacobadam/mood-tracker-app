    ...
    <>
      <div className="w-full">
        <div className="flex flex-2">
          <button
            onClick={openModal}
            className="min-w-full lg:min-w-80 h-20 p-6 rounded-3xl bg-lavender-300 hover:bg-lavender-200 text-white border-none mt-2 lg:mt-0 font-bold text-sm"
          >
            LOG MOOD
          </button>
      ...
      {isModalOpen && (
        <MoodSelectorModal
          onClose={closeModal}
          onMoodSelect={(mood: MoodTypeUnion) => {
            onMoodSelect(mood);
            closeModal();
          }}
        />
