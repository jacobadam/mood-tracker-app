  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="relative p-8 rounded-2xl bg-lavender-100">
        ...
        <h2 className="text-4xl font-extrabold mb-4 text-center pb-8">
        ...
        <div className="flex justify-between gap-4 mt-4">
          {moodButtons.map((mood, index) => (
            <button
              key={index}
              className="flex flex-col items-center justify-center w-[252px] h-[242px] bg-white p-6 rounded-3xl hover:bg-lavender-200 border-none text-2xl"
